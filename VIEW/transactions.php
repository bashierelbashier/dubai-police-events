...
<body>
    ...
    <div class="col-xs-10 navbar-fixed-top pull-right" style="margin-right: 16.7%;height:95px;border-bottom-style: outset;border-bottom-width: 1px;padding-right:5px;padding-left:6px;border-bottom-color: lightgray;padding-top: 15px;  background-color: #ffffff;margin-top:55px; ">
        ...
        <div class="col-xs-2 pull-right dropdown" style="background-color:white;height:30px;color:black;border-width:0px;">
            ...
            <ul style="margin-top:10px;" class="dropdown-menu col-xs-12">
                <li style="background-color: lightgrey;color:black;" class="col-xs-12 dropdown-header"><span class="pull-right">المعاملات</span></li>
                ...
                <li style="background-color: lightgrey;color:black;" class="col-xs-12 dropdown-header"><span class="pull-right">الأراضي</span></li>
    ...
    <div class="col-xs-10 well" id="past_transactions_table" style="min-height:81.5%;margin-top:130px;background-color:white;">
