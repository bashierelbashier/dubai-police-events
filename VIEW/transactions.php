...
<div class="col-md-12 navbar-fixed-top" style="height:55px;background-color: #1b5e20 ;padding-left: 0px;">
    <a style="cursor:pointer;" class="col-xs-9 pull-right">
        <p class="col-xs-12 pull-right" id="classes" style="margin-top:7px;color:white;font-size:x-large">
            <b> <i class="fa fa-exchange"></i> المعاملات السابقة للأراضي </b>
        </p>
    </a>
...
<div class="col-xs-10 navbar-fixed-top pull-right" style="margin-right: 16.7%;height:110px;border-bottom-style: outset;border-bottom-width: 1px;padding-right:5px;padding-left:6px;border-bottom-color: lightgray;padding-top: 15px;  background-color: #ffffff;margin-top:55px; ">

    <div class="col-xs-2 pull-right dropdown" style="background-color:white;height:30px;color:black;border-width:0px;" >
        ...
        <ul style="margin-top:10px;" class="dropdown-menu col-xs-12">
            <li style="font-size:medium;background-color: lightgrey;color:black;" class="col-xs-12 dropdown-header"><span class="pull-right" >المعاملات</span></li>
            <li id="print_transactions_in_period" ><a href="#print_report"><p style="color:#6a6a6a;font-family: 'Droid Arabic Naskh', serif;" align="right"> <i class="fa fa-file-pdf-o"></i> في فترة زمنية </p></a></li>
            <li id="print_transactions_for_land" ><a href="#print_report"><p style="color:#6a6a6a;font-family: 'Droid Arabic Naskh', serif;" align="right"> <i class="fa fa-file-pdf-o"></i> لقطعة أرض معينة </p></a></li>
            <li style="font-size:medium;background-color: lightgrey;color:black;" class="col-xs-12 dropdown-header"><span class="pull-right" >الأراضي</span></li>
            <li id="print_ended_rent_lands" ><a href="../REPORTS/NotInvestedLands.php"><p style="color:#6a6a6a;font-family: 'Droid Arabic Naskh', serif;" align="right"> <i class="fa fa-file-pdf-o"></i> منتهية الإيجارة </p></a></li>
        </ul>
    </div>
    ...
    <div class="input-group col-xs-2 pull-left">
        ...
        <input type="search" style="border-radius:0px;border-top-width: 0px;border-left-width: 0px;border-right-width: 0px" id="filter_to" class="form-control" placeholder="إلى تاريخ ..." />
    </div>
    ...
    <div class="input-group col-xs-2 pull-left">
        ...
        <input type="search" style="border-radius:0px;border-top-width: 0px;border-left-width: 0px;border-right-width: 0px" id="filter_from" class="form-control" placeholder="من تاريخ ..." />
	</div>
...
<div class="col-xs-10 well" id="past_transactions_table" style="min-height:81.5%;margin-top:145px;background-color:white;">
        ...
        $(document).on('click','.pagination-link',function(e) {
            ...
            if (link == 'prev_set'){
                ...
                $.ajax({
                    ...
                    method : "POST",
                    data : {filter_from:filter_from,trans_no:trans_no,filter_to:filter_to,limit:20,start:(link-1)*20},
...
///////////////////////////////////////////////////////////////////////////////
        $("#filter_from").change(function(){
            ...
            $.ajax({
                url:"../MODEL/fetch_transactions.php",
                method : "POST",
                data : {filter_from:filter_from,filter_to:filter_to,start:0,limit:20,trans_no:trans_no},
                success : function(data)
                {
                    $("#past_transactions_table").html(data);
                }
