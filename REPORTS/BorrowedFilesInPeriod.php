...
class MYPDF extends TCPDF {
	...
	public function Header() {
        ...
        $this->Cell('', 5,' الملفات المُسْتَلَفة في الفترة من  : '.$_GET['from_date'].' إلى : '.$_GET['to_date'], 0, true, 'C', 0, '', 0, true, 'M', 'M');
        $this->ln();
        $this->ln();
        $this->ln();
...
WHERE BORROW_DATE <= '".$_GET['to_date']."' AND BORROW_DATE >= '".$_GET['from_date']."'";
